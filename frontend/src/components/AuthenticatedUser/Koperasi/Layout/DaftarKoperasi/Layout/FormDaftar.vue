    ...
    <div class="row">
      ...
      <div class="col-md-8">
        ...
        >
          ...
          >
            <q-input filled square clearable type="text" v-model="form.name" :rules="[val => !!val || 'Field is required']"
                     label="Nama Koperasi">
              <template v-slot:prepend>
                <q-icon name="fa fa-id-card"/>
              </template>
            </q-input>
            <q-input filled square clearable type="text" v-model="form.pendiri" :rules="[val => !!val || 'Field is required']"
                     label="Nama Pendiri Koperasi">
              <template v-slot:prepend>
                <q-icon name="person"/>
              </template>
            </q-input>
            <q-input filled square clearable type="text" v-model="form.alamat" :rules="[val => !!val || 'Field is required']"
                     label="Alamat Lengkap Koperasi">
              <template v-slot:prepend>
                <q-icon name="place"/>
              </template>
            </q-input>
            <q-input filled square clearable type="text" v-model="form.email" :rules="[val => !!val || 'Field is required']"
          ...
          <q-step
            ...
            caption="Optional"
          >
            <q-input filled square v-model="form.date" :rules="[val => !!val || 'Field is required']"
            ...
            <q-input filled square clearable type="text" v-model="form.izin" :rules="[val => !!val || 'Field is required']"
                     label="No Izin Mendirikan Koperasi">
              <template v-slot:prepend>
                <q-icon name="lock"/>
              </template>
            </q-input>
            <q-select filled square ref="input" clearable type="text" v-model="form.jenis" :options="options" :rules="['date', val => !!val || 'Field is required']"
